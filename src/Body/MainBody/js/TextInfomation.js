...
export default function TextInfomation() {
  return (
    <div className={styles.divTextInfoContainer}>
    <div className={styles.divAuthorContainer}>
      <a className={styles.styledAuthorAnchor} href="/@kellygaming2003">
        <h3 className={styles.h3AuthorTitle}>kellygaming2003</h3>
        <h4 className={styles.h4AuthorName}>Kelly Sad Boy 🤡💦</h4>
      </a>
    </div>
    ...
    <div className={styles.divContainer}>
      ( <span className={styles.spanText}>Đi cùng em 🤣</span>
      <a href="/tag/kellygamingtv">
        <strong className={styles.strongText}>#kellygamingtv</strong>
      </a>
      )
      <h4 className={styles.h4Link}>
        <a href="/music/sᴛᴀʏ-ᴡɪᴛʜ-ᴍᴇ-7068910943098522395">
          <svg
            viewBox="0 0 48 48"
